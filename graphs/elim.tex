...
\begingroup
  ...
  \begin{picture}(8640.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(7256,4602){\makebox(0,0)[r]{\strut{}One elimination solver (0 zero errors)}}%
      \csname LTb\endcsname%
      \put(7256,4382){\makebox(0,0)[r]{\strut{}Multiple elimination solver ($step = 1$) (0 zero errors)}}%
      \csname LTb\endcsname%
      \put(7256,4162){\makebox(0,0)[r]{\strut{}Multiple elimination solver ($step = 2$) (0 zero errors)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{graphs/elim}}%
    \gplfronttext
  \end{picture}%
\endgroup
