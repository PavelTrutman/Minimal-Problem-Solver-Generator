...
\begingroup
  ...
  \begin{picture}(8640.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(7256,4602){\makebox(0,0)[r]{\strut{}Systematical generator (0 zero errors)}}%
      \csname LTb\endcsname%
      \put(7256,4382){\makebox(0,0)[r]{\strut{}$F_4$ strategy without matrix partitioning (0 zero errors)}}%
      \csname LTb\endcsname%
      \put(7256,4162){\makebox(0,0)[r]{\strut{}$F_4$ strategy and matrix partitioning (0 zero errors)}}%
    }%
    \gplbacktext
