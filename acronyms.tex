...
\newacronym{deg of f}{$\deg(f)$}{The total degree of the polynomial $f$}
...
\Acronym{$S(f_1, f_2)$}{S-polynomial of the polynomials $f_1$ and $f_2$}
\Acronym{SBBD form}{Singly-bordered block-diagonal form}
